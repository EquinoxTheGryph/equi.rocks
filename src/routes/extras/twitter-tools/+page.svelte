...
<div class="container p-4">
	...
	<article class="p-2">
		...
		<section class="container">
			...
			{:else}
				<h6>
					Start typing in the box above to see your result! Invisible characters will be shown as a
					line
				</h6>
			{/if}
		</section>
...
<em>This page does not collect any user data and only runs locally.</em>
